"""Shared redaction helpers for Text-to-SQL, workflow, and AG-UI boundaries."""
...
def redact_text(value: str) -> str:
    """Redact secrets, DSNs, and regex-covered PII from a plain text string."""
    return _mask_pii_text(_redact_text(value))
