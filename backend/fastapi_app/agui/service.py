...
# SSRF-валидация и DNS-пиннинг вынесены в общий модуль url_safety (его же
# используют html_utils, codeinterpreter, custom_tools/web_tools, utils).
from url_safety import (
    pin_dns_resolution as _pin_dns_resolution,
