...
_BAD_PAYLOADS: list[tuple[str, dict, str]] = [
    ...
    ("storybook_pipeline", {"task": "ok", "project_id": "../outside"}, "project_id"),
    ("storybook_pipeline", {"task": "ok", "project_id": "/tmp/outside"}, "project_id"),
    ("storybook_pipeline", {"task": "ok", "project_id": "."}, "project_id"),
    ("storybook_pipeline", {"task": "ok", "project_id": "project/.."}, "project_id"),
    ("storybook_pipeline", {"task": "ok", "project_id": "a/../b"}, "project_id"),
    ("storybook_pipeline", {"task": "ok", "project_id": "a/b"}, "project_id"),
    ("storybook_pipeline", {"task": "ok", "project_id": r"a\b"}, "project_id"),
